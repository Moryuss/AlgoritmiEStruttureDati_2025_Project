...
public class CalcoloUsoMemoria {
	...
	public static int calcolaUsoMemoria(IStatisticheEsecuzione stats, TipoCella tipoCella) {
	...
	public static int calcolaUsoMemoriaSingolaGriglia(IStatisticheEsecuzione stats, TipoCella tipoCella) {
	    int larghezza = stats.getLarghezzaGriglia();
	    int altezza = stats.getAltezzaGriglia();
	...
	public static String formattaMemoria(int byteTotali) {
	    if (byteTotali < 1024)
	        return byteTotali + " B";
